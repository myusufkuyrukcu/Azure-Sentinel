...
class ImpervaFilesHandler:
    ...
    def decrypt_and_unpack_file(self, file_name, file_content):
        ...
        # 1. Header Kontrolü (Header yoksa exception yerine tüm dosyayı al)
    ...
    def parse_cef(self,cef_raw):
        ...
        # Header array uzunluk kontrolü (opsiyonel güvenlik)
